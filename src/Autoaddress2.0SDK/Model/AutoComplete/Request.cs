...
namespace Autoaddress.Autoaddress2_0.Model.AutoComplete
{
    ...
    public class Request
    {
        ...
        public Request(string address, Language language, Country country, int limit, bool geographicAddress, bool vanityMode, bool addressElements, string addressProfileName, string txn = null)
        {
            Address = address;
            Language = language;
            Country = country;
